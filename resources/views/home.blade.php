...
<body>
	...
	<div class="nc-mainwrapper">
		...
		<!-- CONTENT AREA -->
		<div id="nc-main" class="nc-main bg-cover bg-cc" data-kbgslider="/images/yeffd-bg-1.jpg|/images/yeffd-bg-5.jpg|/images/yeffd-bg-7.jpg">
			...
			<!-- BACKGROUND OVERLAY -->
			<div class="nc-main--bgoverlay min-vh-h100 w100 pos-rel" data-bgcolor="rgba(0,0,0,0.4)">
				<!-- PAGEWRAPPER -->
				<div class="nc-main--pagewrapper nc-activeintro">
					...
					<div id="nc-intropage" class="nc-intropage introsection min-vh-h100 flex-cc w100 pd-tb-small" data-nc-sm="flex-column">
						...
						<!-- LOGO -->
						<div class="nc-logo align-c absolute top-80 left-80 animated s008" data-animIn="fadeInUp|0.1" data-animOut="fadeOutUp|0.1" data-nc-sm="pos-inherit pd-0 mr-b-60">
							<a href="{{ url('/') }}" class="inline-block">
								<img src="/images/yeffd-logo.png" alt="ncodeart">
							</a>
						</div><!-- / LOGO -->

						<div class="container mr-r-0" data-nc-sm="mr-auto w100">
							<!-- INTRO TEXT -->
							<div class="introtext typo-light align-c">
															
								<h1 class="introtext--two fs70 f-1 bold-5 mr-tb-10 animated s008" data-animIn="fadeInUp|0.3" data-animOut="fadeOutUp|0.3" data-nc-md="fs80" data-nc-sm="fs50">
									<span style="color:#ED7143;">Y</span>.
									<span style="color:#94D81E;">E</span>.
									<span style="color:#FE31BA;">F</span>.
									<span style="color:#FEE65D;">F</span>.
									<span style="color:#03D6DE;">D</span>   
								</h1>

								<h1 class="introtext--one fs32 txt-upper f-1 mr-tb-10 animated s008" data-animIn="fadeInUp|0.2" data-animOut="fadeOutUp|0.2" data-nc-md="fs30" data-nc-sm="fs22" style="text-shadow: 2px 2px #000;">YOUNG ENTREPRENEURS AND <br>FUTURE FASHION DESIGNERS</h1>

							</div><!-- / INTRO TEXT -->

							<div class="mr-t-80 align-c" data-nc-sm="mr-t-40">
								<a href="{{ url('/donate') }}" data-popup="donation" class="nc-trigger btn btn-primary solid bdr-1 round txt-upper f-1 animated s008" data-animIn="zoomIn|0.5" data-animOut="zoomOut|0.5">DONATE</a>	
							</div>
